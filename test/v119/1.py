...
if __name__ == "__main__":
    # main()
    # generate_sentences("विड्रॉल नहीं हो पाया",10)
    calculate_similarity("Game Rule",["What are the game rules?",
"How do you play the game?",
"Can you explain the rules of the game?",
"Tell me about the game rules.",
"What do I need to know to play this game?",
"What are the rules for this game?",
"How does this game work? What are the rules?",
"Could you give me a rundown of the rules?",
"Can you tell me how the game is played?",
"What's the rulebook for this game?"],EMBEDDING_MODEL_NAME=EMBEDDING_MODEL_NAME)
