...
class APIClient:
    ...
    def request(self, method: str, endpoint: str, params: Dict = None, 
                data: Any = None, headers: Dict = None, retry: int = 3) -> Dict:
        """
        通用请求方法
    ...
    def add_knowledge(self, title: str, content: str, category: str = None,
    ...
    def transfer_to_human(self, conversation_id: str, reason: str = None) -> Dict:
        """转人工"""
