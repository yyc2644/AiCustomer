...
class AssertHelper:
    ...
    def assert_intent(self, actual: str, expected: str, message: str | None = None) -> bool:
        """
        断言意图匹配
    ...
    def assert_intent_similar(self, actual: str, expected: str, threshold: float | None = None) -> bool:
        """
        断言意图相似（支持包含关系）
    ...
    def assert_answer_contains(self, actual: str, expected: str, message: str | None = None) -> bool:
        """
        断言答案包含关键词
    ...
    def assert_answer_exact(self, actual: str, expected: str, message: str | None = None) -> bool:
        """
        断言答案完全匹配
    ...
    def assert_similarity(self, actual: str, expected: str, threshold: float | None = None, 
                        use_semantic: bool = False, message: str | None = None) -> float:
        """
        断言语义相似度
    ...
    def assert_slots(self, actual: Dict, expected: Dict, message: str | None = None) -> bool:
        """
        断言槽位匹配
    ...
    def assert_node(self, actual_node: str, expected_node: str, message: str | None = None) -> bool:
        """
        断言节点匹配
    ...
    def assert_node_transition(self, from_node: str, to_node: str, 
                             valid_transitions: List[str], message: str | None = None) -> bool:
        """
        断言节点跳转是否合法
    ...
    def assert_not_empty(self, value: Any, field_name: str = "字段", message: str | None = None) -> bool:
        """
        断言非空
    ...
    def assert_status_code(self, actual: int, expected: int, message: str | None = None) -> bool:
        """
        断言HTTP状态码
    ...
    def assert_batch_results(self, results: List[Dict], threshold: float | None = None) -> Dict:
        """
        批量断言测试结果
...
def assert_intent(actual: str, expected: str, message: str | None = None) -> bool:
    """断言意图匹配"""
    return _default_helper.assert_intent(actual, expected, message)


def assert_intent_similar(actual: str, expected: str, threshold: float| None  = None) -> bool:
    """断言意图相似"""
    return _default_helper.assert_intent_similar(actual, expected, threshold)


def assert_answer_contains(actual: str, expected: str, message: str | None = None) -> bool:
    """断言答案包含关键词"""
    return _default_helper.assert_answer_contains(actual, expected, message)


def assert_similarity(actual: str, expected: str, threshold: float| None  = None, 
                     use_semantic: bool = False, message: str | None = None) -> float:
    """断言语义相似度"""
    return _default_helper.assert_similarity(actual, expected, threshold, use_semantic, message)


def assert_slots(actual: Dict, expected: Dict, message: str | None = None) -> bool:
    """断言槽位匹配"""
    return _default_helper.assert_slots(actual, expected, message)


def assert_node(actual_node: str, expected_node: str, message: str | None = None) -> bool:
    """断言节点匹配"""
    return _default_helper.assert_node(actual_node, expected_node, message)


def assert_response_time(response_time: float, max_time: float, message: str | None = None) -> bool:
    """断言响应时间"""
    return _default_helper.assert_response_time(response_time, max_time, message)


def assert_not_empty(value: Any, field_name: str = "字段", message: str | None = None) -> bool:
    """断言非空"""
    return _default_helper.assert_not_empty(value, field_name, message)


def assert_batch_results(results: List[Dict], threshold: float | None = None) -> Dict:
    """批量断言测试结果"""
