...
class TestDialogTurn:
    ...
    def test_dialog_turn_creation(self):
        """测试对话轮次创建"""
        from src.lib.bot_simulator import DialogTurn
...
class TestChatSession:
    ...
    def test_chat_session_creation(self):
        """测试对话会话创建"""
        from src.lib.bot_simulator import ChatSession
    ...
    def test_add_turn(self):
        """测试添加对话轮次"""
        from src.lib.bot_simulator import ChatSession, DialogTurn
...
class TestDBManager:
    ...
    def test_db_manager_creation(self, mock_config):
        """测试数据库管理器创建"""
        from src.lib.db_manager import DBManager, DBConfig
...
class TestLocatorHelper:
    ...
    def test_css_locator(self):
        """测试CSS定位器"""
        from src.lib.page_objects.base import LocatorHelper
...
class TestConvenienceFunctions:
    ...
    def test_create_client(self):
        """测试创建API客户端便捷函数"""
        from src.lib.api_client import create_client
    ...
    def test_create_simulator(self):
        """测试创建模拟器便捷函数"""
        from src.lib.bot_simulator import create_simulator
    ...
    def test_create_db_manager(self):
        """测试创建数据库管理器便捷函数"""
        from src.lib.db_manager import create_db_manager
